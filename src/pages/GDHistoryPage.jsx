...
export default function GDHistoryPage() {
  ...
  useEffect(() => {
    ...
    const history = getSessionHistory('gd');
          ...
          <div className="max-w-6xl mx-auto px-4 lg:px-6 py-4 lg:py-8">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 dark:text-slate-400">
                Track your GD practice performance
              </p>
            </div>
              ...
              {sessions.length === 0 ? (
                <div className="p-12 text-center">
                  <p className="text-lg text-gray-600 dark:text-slate-400 mb-4">
                    📋 No sessions yet — start your first GD session!
                  </p>
                  <button
                    onClick={() => navigate('/practice/gd')}
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex gap-2 mb-2">
                            <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-semibold rounded-full">
                              {session.category || 'Group Discussion'}
                            </span>
                          ...
                          <div className="space-y-4">
                            <div className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg border border-gray-200 dark:border-slate-600">
                              <p className="text-sm text-gray-700 dark:text-slate-300">
                                {session.feedback || 'Feedback will be available after submission.'}
                              </p>
                            </div>
                          </div>
                        </div>
