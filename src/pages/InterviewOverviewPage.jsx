      ...
      <main className="flex-1 flex flex-col pb-20 lg:pb-0">
        ...
        >
          <div className="max-w-6xl mx-auto px-4 lg:px-6 py-4 lg:py-8">
            ...
            >
              <motion.div className="bg-[#111111] rounded-xl p-6 border border-[#222222] hover:shadow-lg hover:shadow-blue-500/20" whileHover={{ scale: 1.03, transition: { type: 'spring', stiffness: 400, damping: 10 } }}>
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex gap-4">
                  <div className="flex flex-col items-center">
                    <span className="px-4 py-2 bg-[#1A1A1A] text-slate-300 rounded-lg font-semibold mb-2">Promising</span>
            ...
            {/* Recent Sessions */}
            <motion.div className="bg-[#111111] rounded-xl border border-[#222222] overflow-hidden mb-8" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.7 }}>
                    ...
                    >
                      ...
                      {expandedSessionId === session.id && (
                        <div className="mt-6 pt-6 border-t border-[#222222]">
                          ...
                          <motion.button
                            onClick={() => navigate('/practice/interview')}
                            className="w-full mt-6 bg-blue-600 hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/20 text-white font-semibold py-2 px-4 rounded-lg transition-colors"
                            whileHover={{ scale: 1.03, transition: { type: 'spring', stiffness: 400, damping: 10 } }}
                          >
